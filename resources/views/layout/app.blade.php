...
@yield('content')
<footer class="pt-4 pb-4 text-center text-muted d-print-none">
    <div class="container">
        <div class="my-3">
            <div class="h4">David Christian Cosmas</div>
                ...
                <nav role="navigation">
                    <ul class="nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link" href="https://linkedin.com/in/chrisdavid32"
                                title="Facebook"><i class="fab fa-linkedin-in"></i><span
                                    class="sr-only menu-title">Linkedin</span></a>
                        </li>
